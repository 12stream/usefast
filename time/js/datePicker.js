    ...
    $.fn.datePicker = function(options) {
        return this.each(function(e) {
            ...
            function init() { //初始化函数
                ...
                // $('#datePlugin').on('click', function(event) {
                //     console.log("111");
                //     destroyScroll();
                //     $('#datePlugin').hide().html('');
                //     document.getElementsByTagName('body')[0].removeEventListener('touchmove', cancleDefault, false);
            ...
            function renderDom() {
                var mainHtml = ' <div class="d-date-box"><div class="d-date-title"><span class="d-btn" id="d-cancleBtn">取消</span><span class="choicedate">请选择日期</span><span class="d-btn" id="d-okBtn">确定</span></div><p class="d-date-info"><span class="d-day-info"></span><span class="d-return-info"></span></p></div>';
